...
HRESULT UI::Init()
{
	...
	ImageManager::GetSingleton()->AddImage("ª°∞≠", "Image/lifebar_red.bmp", WINSIZE_X, 6 * 3.22, true, RGB(255, 0, 255));
	ImageManager::GetSingleton()->AddImage("∞À¡§", "Image/lifebar_black.bmp", WINSIZE_X, 6 * 3.22, true, RGB(255, 0, 255));
